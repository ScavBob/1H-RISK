...
public class Faction implements Serializable {
    ...
    public static Faction Germany = new Faction("Germany", 2,0.20, 0, 0.10, 0, 0, 0); // -5 staring bonus +3 continental bonus
    public static Faction France = new Faction("France", 3, 0, 0, 0.30, 0.05, 0, 0); // +5 starting bonus -1 continental bonus
    public static Faction Britain = new Faction("Britain", 4, 0.20, -0.10, 0.10, 0, 1, -1); // -7 staring bonus +4 continental bonus
    public static Faction America = new Faction("America", 5, 0, 0.30, -0.10, 0.10, 0, 0); //
    public static Faction Italy = new Faction("Italy", 6,0.10, 0, 0, 0.40, 0, 0); //
    public static Faction Russia = new Faction("Russia", 7, 0.40, 0, 0.10, 0, 2, -2); //
