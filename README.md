...
### Controls:
Please refer to the in-game tutorial to learn about the Controls and How to Play.
...
## Modifications
1. Different countries with individual starting bonuses instead of basic teams.
2. Countries with different battle music and different UI elements, i.e. flags and colors.
3. Bilkent University map.
